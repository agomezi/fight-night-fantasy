          ...
          cards={[
            {
              ...
              ...(myStanding && LEAGUE
                ? {
                    ...
                    mark: <CardMark name="trophy" color="#E5B23C" opacity={0.17} />,
                ...
                : {
                    serial: "NO LEAGUE",
                    mark: <CardMark name="trophy" color="#E5B23C" opacity={0.09} />,
                    tag: "LEAGUES",
                    tagColor: "#E8A020",
            ...
            },
            {
              ...
              ...(lastEventPoints > 0
                ? {
                    serial: "UFC 299",
                    mark: <CardMark name="belt" top={44} opacity={0.2} />,
                ...
                : {
                    serial: "IN 2 DAYS",
                    mark: <CardMark name="belt" top={44} opacity={0.1} />,
